...
//          print("\(psp.mergeable(ps))")
//          print("newPSForMerge: \(newPSForMerge)")
//          print("Original psp: \(psp)")
//          print(psp.subtract(newPSForMerge, canonicityLevel: .full))
//          if !newPSForMerge.isEmpty() {
//            if ps.mergeable(newPSForMerge) {
//              res.insert(psp)
//            }
